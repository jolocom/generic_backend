...
import { debugConfig, gatewayUrl, AccessTokens, generateHeadersFromAccessTokens } from './utils';

const spendUserCheque = (
...
const configuredSpendUserCheque = spendUserCheque(
    debugConfig,
    gatewayUrl
)
